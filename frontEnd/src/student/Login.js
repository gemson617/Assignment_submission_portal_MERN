...
<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 shadow-lg">
  <div class="mx-auto max-w-lg  bg-black rounded-xl p-3">
    <h1 class="text-center text-2xl font-bold text-indigo-600 sm:text-3xl ">LogIn</h1>
    
    <form action="" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8" onSubmit={handleSubmit(onSubmit)}>
